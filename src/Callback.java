...
class Callback implements PanelProvider.PanelCallback, MqttCallback {
   ...
   public void setLabelArming(char modeChar, String modeLabel) {
      ...
      if (discoveryEnabled && !modeDiscoverySent.contains(modeIDInt)) {
         ...
         try {
            ...
            System.out.println("ERROR: invio discovery bottone mode: " + topic);
         }
      }
   }
   ...
   public void sendMessageOnsetPartitionArming(int partitionID) {
      ...
      if(VERBOSE_DEBUG) {
         System.out.println("DEBUG: Partizion Name: " + this.partitionNames[partitionID] + " Arming: " + this.partitionArmStatuses[partitionID] + " Status: " + this.partitionStatuses[partitionID]);
      }
   }
   ...
   public void setPartitionRemoteName(String partitionID, String partitionName) {
      ...
      if(VERBOSE_DEBUG) {
         System.out.println("DEBUG: Partizion Name: " + this.partitionNames[partitionIDInt] + " Arming: " + this.partitionArmStatuses[partitionIDInt] + " Status: " + this.partitionStatuses[partitionIDInt]);
      }
   }
